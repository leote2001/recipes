...
import AreasYCategorias from './AreasYCategorias';
export default function Search_Filter() {
  ...
  return (
    ...
    <h2>Search</h2>
      ...
      <AreasYCategorias setCurrentPage={setCurrentPage} setLoading={setLoading} setError={setError} setAllRecetas={setAllRecetas}/>
